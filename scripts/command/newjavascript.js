...
var scrollssprice = new Array(1, 1, 2, 2, 5, 10);
var gmscrolls = new Array(2044503, 2044703, 2044603, 2043303, 2044303, 2044403, 2043803, 2043703, 2043003, 2044003, 2043203, 2044203, 2043103, 2044103, 2040506, 2040709, 2040710, 2040711, 2040303, 2040807, 2040806, 4031608);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        sel1 += "\r\n #L4#GM Scrolls Shop#r - (to taunt you 25 tao each)#l";
        sel1 += "\r\n #L4#Snow Rose Shop #r - (5 tao each) #l#b ";
        sel1 += "\r\n #L5#Chair Shop #r - (5 tao each) #l#b ";
        sel1 += "\r\n\r\n\r\n";
        cm.sendSimple(sel1);
    } else if (status == 1) {
        var sel2= " ";
        ...
        if (cm.getPlayer().haveSight(qty * scrollsprice[seltype])){
            cm.gainItem(tao, - (qty * scrollssprice[seltype]));

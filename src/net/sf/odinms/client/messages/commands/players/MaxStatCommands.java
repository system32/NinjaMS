...
public class MaxStatCommands implements PlayerCommand {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        if (splitted[0].equalsIgnoreCase("shuriken")) {
            ...
            int goldscam = Math.min(((msicount + 1) * 250), 13337);
    ...
    public PlayerCommandDefinition[] getDefinition() {
     ...
     private boolean checkEtcItems(MapleCharacter player, byte msicount) {
        switch(msicount){
            ...
            case 1:
            case 2:
                return (player.haveItem(4000020, 250)) && player.haveItem(4000069, 500); // Wild Boar Tooth and Zombie tooth
            case 3:
            case 4:
                return (player.haveItem(4000002, 500)) && player.haveItem(4000168, 1000); // Pig's Ribbon and sun flower Seed
            case 5:
            case 6:
                return (player.haveItem(4000001, 750)) && player.haveItem(4000078, 1500); // orange mushy cap and jr cerebres tooth
            case 7:
                return (player.haveItem(4000051, 1000)) && player.haveItem(4000184, 2000); // Hector Tails and Butter Toasted Squid
            case 8:

                return (player.haveItem(4000040, 50)) && player.haveItem(4000176, 50) &&
                        player.haveItem(4000074, 2000) && player.haveItem(4000014, 2500); // mushroom spore, poisonous mushroom,
     ...
     private void removeItems(MapleCharacter player, byte x) {
         switch(x){
            ...
            case 1:
            case 2:
                player.gainItem(4000020, -250);
                player.gainItem(4000069, -500); // Wild Boar Tooth and Zombie tooth
                break;
            case 3:
            case 4:
                player.gainItem(4000002, -500);
                player.gainItem(4000168, -1000); // Pig's Ribbon and sun flower Seed
                break;
            case 5:
            case 6:
                player.gainItem(4000001, -750);
                player.gainItem(4000078, -1500); // orange mushy cap and jr cerebres tooth
                break;
            case 7:
                player.gainItem(4000051, -1000);
                player.gainItem(4000184, -2000); // Hector Tails and Butter Toasted Squid
                break;
            case 8:
                player.gainItem(4000040, -50);
                player.gainItem(4000176, -50);
                player.gainItem(4000074, -2000);
                player.gainItem(4000014, -2500); // mushroom spore, poisonous mushroom,
                break;
            // lucida tail & drake skull.
            default:
                break;
    ...
    private String require (byte x){
        switch(x){
            ...
            case 1:
            case 2:
                return "You need to have 250 Wild Boar tooth and 500 Zombie Tooth";
            case 3:
            case 4:
                return "You need to have 500 Pig Ribbon and 1000 Sun Flower Seed.";
            case 5:
            case 6:
                return "You need to have 750 Orange mushroom caps and 1500 Jr CereBres Tooth";
            case 7:
                return "You need to have 1000 Hector Tails and 2000 Butter Toasted Squids";
            case 8:
                return "You need to have 50 Mushmom Spore, 50 Poisonous mushroom, 2000 lucida Tail, 2500 Drake Skull";
            default:
                return "Some thing wrong. Report to a GM";
        }
    }
